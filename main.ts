...
function lvl1 () {
    ...
    pause(2000)
    person.ay = 700
    controller.moveSprite(person, 95, 0)
...
function level_contol () {
    ...
    if (level == 1) {
        ...
        jumpboostshop = sprites.create(assets.image`jump boost`, SpriteKind.Button)
        jumpboostshop.setPosition(22, 42)
    }
    if (level == 2) {
        sprites.destroyAllSpritesOfKind(SpriteKind.Button)
...
function coins () {
    for (let value of tiles.getTilesByType(assets.tile`coinnn`)) {
        coin2 = sprites.create(img`
            ...
            . . f f f f . . 
            `, SpriteKind.coin)
        tiles.placeOnTile(coin2, tiles.getTileLocation(0, 0))
